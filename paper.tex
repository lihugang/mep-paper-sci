...
\include{paper/body/script-system.tex} % 脚本系统
\include{paper/body/difficulties&performance.tex} % 技术难点和性能优化
\include{paper/body/hope.tex} % 展望
\include{paper/body/thanks.tex} % 致谢
